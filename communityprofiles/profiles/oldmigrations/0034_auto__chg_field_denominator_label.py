...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('profiles_denominator', 'label', self.gf('django.db.models.fields.CharField')(max_length=50))


    def backwards(self, orm):
        
        # Changing field 'Denominator.label'
        db.alter_column('profiles_denominator', 'label', self.gf('django.db.models.fields.CharField')(max_length=30))
