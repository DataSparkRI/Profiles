...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'GeoLevel.display_name'
        db.add_column(u'profiles_geolevel', 'display_name', self.gf('django.db.models.fields.CharField')(db_index=True, max_length=200, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'GeoLevel.display_name'
        db.delete_column(u'profiles_geolevel', 'display_name')
    ...
    models = {
        ...
        u'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 12, 5, 14, 28, 53, 453397)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 12, 5, 14, 28, 53, 452976)'}),
