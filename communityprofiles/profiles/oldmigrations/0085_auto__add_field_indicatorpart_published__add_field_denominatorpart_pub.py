...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'IndicatorPart.published'
        db.add_column(u'profiles_indicatorpart', 'published', self.gf('django.db.models.fields.BooleanField')(default=True), keep_default=False)

        # Adding field 'DenominatorPart.published'
        db.add_column(u'profiles_denominatorpart', 'published', self.gf('django.db.models.fields.BooleanField')(default=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'IndicatorPart.published'
        db.delete_column(u'profiles_indicatorpart', 'published')

        # Deleting field 'DenominatorPart.published'
        db.delete_column(u'profiles_denominatorpart', 'published')
    ...
    models = {
        ...
        u'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 2, 12, 14, 59, 3, 977051)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 2, 12, 14, 59, 3, 976660)'}),
