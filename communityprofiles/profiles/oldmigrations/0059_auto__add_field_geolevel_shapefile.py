...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'GeoLevel.shapefile'
        db.add_column(u'profiles_geolevel', 'shapefile', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['maps.ShapeFile'], null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'GeoLevel.shapefile'
        db.delete_column(u'profiles_geolevel', 'shapefile_id')
    ...
    models = {
        ...
        u'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 11, 22, 12, 33, 44, 904483)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 11, 22, 12, 33, 44, 904070)'}),
