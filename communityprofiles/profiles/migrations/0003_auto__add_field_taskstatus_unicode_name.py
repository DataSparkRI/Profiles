...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'TaskStatus.unicode_name'
        db.add_column(u'profiles_taskstatus', 'unicode_name',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'TaskStatus.unicode_name'
        db.delete_column(u'profiles_taskstatus', 'unicode_name')
