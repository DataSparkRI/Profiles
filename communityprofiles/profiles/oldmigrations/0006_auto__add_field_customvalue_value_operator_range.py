...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'CustomValue.value_operator_range'
        db.add_column(u'profiles_customvalue', 'value_operator_range', self.gf('django.db.models.fields.CharField')(max_length='255', null=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'CustomValue.value_operator_range'
        db.delete_column(u'profiles_customvalue', 'value_operator_range')
    ...
    models = {
        ...
        u'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 5, 13, 8, 57, 22, 609224)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 5, 13, 8, 57, 22, 608823)'}),
        ...
        u'profiles.customvalue': {
            ...
            'value_operator_range': ('django.db.models.fields.CharField', [], {'max_length': "'255'", 'null': 'True'})
        },
