...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'profiles_denominator', 'slug', self.gf('django.db.models.fields.SlugField')(db_index=True, max_length=100, unique=True, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Denominator.slug'
        db.delete_column(u'profiles_denominator', 'slug')
    ...
    models = {
        ...
        u'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 1, 14, 12, 56, 19, 505008)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 1, 14, 12, 56, 19, 504592)'}),
