...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Denominator.published'
        db.add_column(u'profiles_denominator', 'published',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Denominator.published'
        db.delete_column(u'profiles_denominator', 'published')
