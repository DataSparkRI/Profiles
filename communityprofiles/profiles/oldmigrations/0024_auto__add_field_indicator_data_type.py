...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('profiles_indicator', 'data_type', self.gf('django.db.models.fields.CharField')(default='COUNT', max_length=10), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Indicator.data_type'
        db.delete_column('profiles_indicator', 'data_type')
