...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'CustomValue.data_type'
        db.add_column(u'profiles_customvalue', 'data_type', self.gf('django.db.models.fields.CharField')(default='COUNT', max_length=30), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'CustomValue.data_type'
        db.delete_column(u'profiles_customvalue', 'data_type')
    ...
    models = {
        ...
        u'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 9, 12, 10, 7, 59, 390200)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 9, 12, 10, 7, 59, 389780)'}),
