...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'IndicatorData.percent'
        db.alter_column('profiles_indicatordata', 'percent', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=10, decimal_places=2))


    def backwards(self, orm):
        
        # Changing field 'IndicatorData.percent'
        db.alter_column('profiles_indicatordata', 'percent', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=6, decimal_places=2))
