...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'DataDisplay.display_type'
        db.add_column('profiles_datadisplay', 'display_type', self.gf('django.db.models.fields.CharField')(default='STANDARD', max_length=11), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'DataDisplay.display_type'
        db.delete_column('profiles_datadisplay', 'display_type')
