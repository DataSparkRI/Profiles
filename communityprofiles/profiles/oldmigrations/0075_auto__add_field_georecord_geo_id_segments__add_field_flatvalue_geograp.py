...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'TaskStatus.first_seen'
        db.add_column(u'profiles_taskstatus', 'first_seen', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, null=True, blank=True), keep_default=False)


    def backwards(self, orm):

        # Deleting field 'TaskStatus.first_seen'
        db.delete_column(u'profiles_taskstatus', 'first_seen')
    ...
    models = {
        ...
        u'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 1, 9, 15, 14, 28, 681557)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 1, 9, 15, 14, 28, 681066)'}),
