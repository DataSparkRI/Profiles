...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'CustomValue.value_operator'
        db.alter_column(u'profiles_customvalue', 'value_operator', self.gf('django.db.models.fields.CharField')(default='', max_length='255'))


    def backwards(self, orm):
        
        # Changing field 'CustomValue.value_operator'
        db.alter_column(u'profiles_customvalue', 'value_operator', self.gf('django.db.models.fields.CharField')(max_length='255', null=True))
    ...
    models = {
        ...
        u'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 9, 11, 17, 40, 10, 831428)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 9, 11, 17, 40, 10, 831019)'}),
