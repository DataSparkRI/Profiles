...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'DataDisplay.slug'
        db.alter_column('data_displays_datadisplay', 'slug', self.gf('django.db.models.fields.SlugField')(unique=True, max_length=300))


    def backwards(self, orm):
        
        # Changing field 'DataDisplay.slug'
        db.alter_column('data_displays_datadisplay', 'slug', self.gf('django.db.models.fields.SlugField')(max_length=100, unique=True))
