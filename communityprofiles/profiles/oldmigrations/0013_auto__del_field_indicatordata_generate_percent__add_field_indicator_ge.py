...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'IndicatorData.generate_percent'
        db.delete_column('profiles_indicatordata', 'generate_percent')

        # Adding field 'Indicator.generate_percent'
        db.add_column('profiles_indicator', 'generate_percent', self.gf('django.db.models.fields.BooleanField')(default=True), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'IndicatorData.generate_percent'
        db.add_column('profiles_indicatordata', 'generate_percent', self.gf('django.db.models.fields.BooleanField')(default=True), keep_default=False)

        # Deleting field 'Indicator.generate_percent'
        db.delete_column('profiles_indicator', 'generate_percent')
    ...
    models = {
        ...
        'profiles.indicatordata': {
            ...
            'number': ('django.db.models.fields.DecimalField', [], {'max_digits': '10', 'decimal_places': '2'}),
