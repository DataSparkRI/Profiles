...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'GeoLevel.related_within'
        db.add_column(u'profiles_geolevel', 'related_within',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='related_levels_within', null=True, to=orm['profiles.GeoLevel']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'GeoLevel.related_within'
        db.delete_column(u'profiles_geolevel', 'related_within_id')
