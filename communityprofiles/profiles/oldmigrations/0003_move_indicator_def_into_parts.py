...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        time_2000 = orm.Time.objects.create(name="2000", sort=2000)
        time_2010 = orm.Time.objects.create(name="2010", sort=2010)
        for indicator in orm.Indicator.objects.all():
            time = time_2010
            if '2000' in indicator.name:
                time = time_2000
            orm.IndicatorPart.objects.create(
                indicator=indicator,
