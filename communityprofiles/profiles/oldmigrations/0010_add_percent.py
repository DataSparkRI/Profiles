...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'IndicatorData.percent'
        db.add_column('profiles_indicatordata', 'percent', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=6, decimal_places=2, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'IndicatorData.percent'
        db.delete_column('profiles_indicatordata', 'percent')
