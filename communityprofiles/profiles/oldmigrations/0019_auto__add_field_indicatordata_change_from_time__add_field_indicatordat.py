...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'IndicatorData.change_from_time'
        db.add_column('profiles_indicatordata', 'change_from_time', self.gf('django.db.models.fields.related.ForeignKey')(related_name='data_as_change_from', null=True, to=orm['profiles.Time']), keep_default=False)

        # Adding field 'IndicatorData.change_to_time'
        db.add_column('profiles_indicatordata', 'change_to_time', self.gf('django.db.models.fields.related.ForeignKey')(related_name='data_as_change_to', null=True, to=orm['profiles.Time']), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'IndicatorData.change_from_time'
        db.delete_column('profiles_indicatordata', 'change_from_time_id')

        # Deleting field 'IndicatorData.change_to_time'
        db.delete_column('profiles_indicatordata', 'change_to_time_id')
