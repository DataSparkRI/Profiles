...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('profiles_datadomain', 'name', self.gf('django.db.models.fields.CharField')(unique=True, max_length=100))

        # Changing field 'DataDomain.slug'
        db.alter_column('profiles_datadomain', 'slug', self.gf('django.db.models.fields.SlugField')(unique=True, max_length=100))


    def backwards(self, orm):
        
        # Changing field 'DataDomain.name'
        db.alter_column('profiles_datadomain', 'name', self.gf('django.db.models.fields.CharField')(max_length=20, unique=True))

        # Changing field 'DataDomain.slug'
        db.alter_column('profiles_datadomain', 'slug', self.gf('django.db.models.fields.SlugField')(max_length=20, unique=True))
