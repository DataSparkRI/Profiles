...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'profiles_indicator', 'last_modified_at', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True), keep_default=False)

        # Removing M2M table for field levels on 'Indicator'
        db.delete_table('profiles_indicator_levels')


    def backwards(self, orm):
        
        # Deleting field 'Indicator.last_modified_at'
        db.delete_column(u'profiles_indicator', 'last_modified_at')

        # Adding M2M table for field levels on 'Indicator'
        db.create_table(u'profiles_indicator_levels', (
        ...
        db.create_unique(u'profiles_indicator_levels', ['indicator_id', 'geolevel_id'])
    ...
    models = {
        ...
        u'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 3, 6, 10, 1, 39, 762572)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 3, 6, 10, 1, 39, 762149)'}),
