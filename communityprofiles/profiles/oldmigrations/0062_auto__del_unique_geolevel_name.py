...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Removing unique constraint on 'GeoLevel', fields ['name']
        db.delete_unique(u'profiles_geolevel', ['name'])

        # Adding index on 'GeoLevel', fields ['name']
        db.create_index(u'profiles_geolevel', ['name'])


    def backwards(self, orm):
        
        # Removing index on 'GeoLevel', fields ['name']
        db.delete_index(u'profiles_geolevel', ['name'])

        # Adding unique constraint on 'GeoLevel', fields ['name']
        db.create_unique(u'profiles_geolevel', ['name'])
    ...
    models = {
        ...
        u'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 11, 27, 10, 30, 1, 946671)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 11, 27, 10, 30, 1, 946277)'}),
