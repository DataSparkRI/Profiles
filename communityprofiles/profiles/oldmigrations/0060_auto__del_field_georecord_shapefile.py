...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column(u'profiles_georecord', 'shapefile_id')


    def backwards(self, orm):
        
        # Adding field 'GeoRecord.shapefile'
        db.add_column(u'profiles_georecord', 'shapefile', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['maps.ShapeFile'], null=True, blank=True), keep_default=False)
    ...
    models = {
        ...
        u'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 11, 22, 12, 35, 12, 616318)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 11, 22, 12, 35, 12, 615877)'}),
