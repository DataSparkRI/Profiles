...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'DataDisplayTemplate.featured'
        db.add_column('data_displays_datadisplaytemplate', 'featured', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Removing M2M table for field records on 'DataDisplayTemplate'
        db.delete_table('data_displays_datadisplaytemplate_records')

        # Adding M2M table for field times on 'DataDisplayTemplate'
        db.create_table('data_displays_datadisplaytemplate_times', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('datadisplaytemplate', models.ForeignKey(orm['data_displays.datadisplaytemplate'], null=False)),
            ('time', models.ForeignKey(orm['profiles.time'], null=False))
        ))
        db.create_unique('data_displays_datadisplaytemplate_times', ['datadisplaytemplate_id', 'time_id'])


    def backwards(self, orm):
        
        # Deleting field 'DataDisplayTemplate.featured'
        db.delete_column('data_displays_datadisplaytemplate', 'featured')
        ...
        # Removing M2M table for field times on 'DataDisplayTemplate'
        db.delete_table('data_displays_datadisplaytemplate_times')
