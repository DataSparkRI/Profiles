...
class CensusAPI_ACS5_2013(CensusAPI):
    # API levs supported by api
    def __init__(self):

        super(CensusAPI_ACS5_2013, self).__init__('2013', 'acs5',
                api_levs={
                    '010':'us',
                    '040':'state',
                    '050':'county',
...
class CensusAPI_ACS5_2013_Profile(CensusAPI):
    # API levs supported by api
    def __init__(self):

        super(CensusAPI_ACS5_2013_Profile, self).__init__('2013', 'acs5/profile',
                api_levs={
                    '010':'us',
                    '040':'state',
                    '050':'county',
...
class CensusAPI_ACS5_2014(CensusAPI):
    # API levs supported by api
    def __init__(self):

        super(CensusAPI_ACS5_2014, self).__init__('2014', 'acs5',
                api_levs={
                    '010':'us',
                    '040':'state',
                    '050':'county',
...
class CensusAPI_ACS5_2014_Profile(CensusAPI):
    # API levs supported by api
    def __init__(self):

        super(CensusAPI_ACS5_2014_Profile, self).__init__('2014', 'acs5/profile',
                api_levs={
                    '010':'us',
                    '040':'state',
                    '050':'county',
