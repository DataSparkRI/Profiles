...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Removing unique constraint on 'GeoRecord', fields ['slug']
        db.delete_unique('profiles_georecord', ['slug'])

        # Adding unique constraint on 'GeoRecord', fields ['slug', 'level']
        db.create_unique('profiles_georecord', ['slug', 'level_id'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'GeoRecord', fields ['slug', 'level']
        db.delete_unique('profiles_georecord', ['slug', 'level_id'])

        # Adding unique constraint on 'GeoRecord', fields ['slug']
        db.create_unique('profiles_georecord', ['slug'])
