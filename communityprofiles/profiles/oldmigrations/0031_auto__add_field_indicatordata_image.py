...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'IndicatorData.image'
        db.add_column('profiles_indicatordata', 'image', self.gf('sorl.thumbnail.fields.ImageField')(max_length=100, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'IndicatorData.image'
        db.delete_column('profiles_indicatordata', 'image')
