...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'FlatValue.f_numerator_moe'
        db.add_column(u'profiles_flatvalue', 'f_numerator_moe', self.gf('django.db.models.fields.CharField')(max_length='255', null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'FlatValue.f_numerator_moe'
        db.delete_column(u'profiles_flatvalue', 'f_numerator_moe')
    ...
    models = {
        ...
        u'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 2, 11, 14, 18, 51, 636339)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 2, 11, 14, 18, 51, 635947)'}),
