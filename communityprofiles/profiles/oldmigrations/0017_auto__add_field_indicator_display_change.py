...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Indicator.display_change'
        db.add_column('profiles_indicator', 'display_change', self.gf('django.db.models.fields.BooleanField')(default=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Indicator.display_change'
        db.delete_column('profiles_indicator', 'display_change')
