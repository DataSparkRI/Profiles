...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Indicator.display_distribution'
        db.add_column('profiles_indicator', 'display_distribution', self.gf('django.db.models.fields.BooleanField')(default=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Indicator.display_distribution'
        db.delete_column('profiles_indicator', 'display_distribution')
