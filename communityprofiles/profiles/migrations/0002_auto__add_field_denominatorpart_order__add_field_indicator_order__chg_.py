...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'DenominatorPart.order'
        db.add_column(u'profiles_denominatorpart', 'order',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=1, db_index=True),
                      keep_default=False)

        # Adding field 'Indicator.order'
        db.add_column(u'profiles_indicator', 'order',
                      self.gf('django.db.models.fields.PositiveIntegerField')(null=True, blank=True),
                      keep_default=False)


        # Changing field 'GeoLevel.shapefile'
        db.alter_column(u'profiles_geolevel', 'shapefile_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['maps.ShapeFile'], null=True, on_delete=models.SET_NULL))
        # Adding field 'IndicatorPart.order'
        db.add_column(u'profiles_indicatorpart', 'order',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=1, db_index=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'DenominatorPart.order'
        db.delete_column(u'profiles_denominatorpart', 'order')

        # Deleting field 'Indicator.order'
        db.delete_column(u'profiles_indicator', 'order')


        # Changing field 'GeoLevel.shapefile'
        db.alter_column(u'profiles_geolevel', 'shapefile_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['maps.ShapeFile'], null=True))
        # Deleting field 'IndicatorPart.order'
        db.delete_column(u'profiles_indicatorpart', 'order')
