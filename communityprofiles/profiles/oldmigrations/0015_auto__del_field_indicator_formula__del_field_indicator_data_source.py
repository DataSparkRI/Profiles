...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Indicator.formula'
        db.delete_column('profiles_indicator', 'formula')

        # Deleting field 'Indicator.data_source'
        db.delete_column('profiles_indicator', 'data_source_id')


    def backwards(self, orm):
        
        # Adding field 'Indicator.formula'
        db.add_column('profiles_indicator', 'formula', self.gf('django.db.models.fields.TextField')(default=''), keep_default=False)

        # User chose to not deal with backwards NULL issues for 'Indicator.data_source'
        raise RuntimeError("Cannot reverse this migration. 'Indicator.data_source' and its values cannot be restored.")
