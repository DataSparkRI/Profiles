...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding index on 'GeoRecord', fields ['name']
        db.create_index(u'profiles_georecord', ['name'])

        # Adding index on 'Indicator', fields ['name']
        db.create_index(u'profiles_indicator', ['name'])


    def backwards(self, orm):
        
        # Removing index on 'Indicator', fields ['name']
        db.delete_index(u'profiles_indicator', ['name'])

        # Removing index on 'GeoRecord', fields ['name']
        db.delete_index(u'profiles_georecord', ['name'])
    ...
    models = {
        ...
        u'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 11, 8, 14, 15, 22, 877392)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 11, 8, 14, 15, 22, 876994)'}),
