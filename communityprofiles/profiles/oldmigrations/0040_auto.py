...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('profiles_datadomain_subdomains', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('from_datadomain', models.ForeignKey(orm['profiles.datadomain'], null=False)),
            ('to_datadomain', models.ForeignKey(orm['profiles.datadomain'], null=False))
        ))
        db.create_unique('profiles_datadomain_subdomains', ['from_datadomain_id', 'to_datadomain_id'])
    ...
    models = {
        ...
        'profiles.datadomain': {
            ...
            'subdomains': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['profiles.DataDomain']", 'symmetrical': 'False'}),
