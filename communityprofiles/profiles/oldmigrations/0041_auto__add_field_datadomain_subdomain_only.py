...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'DataDomain.subdomain_only'
        db.add_column('profiles_datadomain', 'subdomain_only', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'DataDomain.subdomain_only'
        db.delete_column('profiles_datadomain', 'subdomain_only')
