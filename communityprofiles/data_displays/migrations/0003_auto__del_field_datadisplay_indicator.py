...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'DataDisplay.indicator'
        db.delete_column('data_displays_datadisplay', 'indicator_id')


    def backwards(self, orm):
        
        # Adding field 'DataDisplay.indicator'
        db.add_column('data_displays_datadisplay', 'indicator', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['profiles.Indicator'], null=True, blank=True), keep_default=False)
