...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'IndicatorPart.data'
        db.add_column('profiles_indicatorpart', 'data', self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'IndicatorPart.data'
        db.delete_column('profiles_indicatorpart', 'data')
