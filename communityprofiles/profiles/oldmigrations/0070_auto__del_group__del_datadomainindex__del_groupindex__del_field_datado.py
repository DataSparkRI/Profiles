...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        db.create_table(u'profiles_group', (
            ...
            ('order', self.gf('django.db.models.fields.CharField')(max_length=100, unique=True, db_index=True)),
        ))
    ...
    models = {
        ...
        u'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 12, 17, 9, 57, 43, 368837)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 12, 17, 9, 57, 43, 368425)'}),
