...
class CustomValue(models.Model):
    ...
    indicator = models.ForeignKey('Indicator')
    value_operator = models.CharField(max_length="255", blank=False, null=False, help_text="The value or An optional comparison operator. Example: '< 5' would map a value less than 5 to the display value. '===10' would map a value equal to 10 to a the display value. available operators include ===, >, <, and !=")
