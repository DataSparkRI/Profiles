...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'DataDomain.publish'
        db.add_column(u'profiles_datadomain', 'publish',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'DataDomain.publish'
        db.delete_column(u'profiles_datadomain', 'publish')
