...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'GeoRecord.geom'
        db.delete_column('profiles_georecord', 'geom')

        # Adding field 'GeoRecord.shapefile'
        db.add_column('profiles_georecord', 'shapefile', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['maps.ShapeFile'], null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'GeoRecord.geom'
        db.add_column('profiles_georecord', 'geom', self.gf('django.contrib.gis.db.models.fields.GeometryField')(null=True, blank=True), keep_default=False)

        # Deleting field 'GeoRecord.shapefile'
        db.delete_column('profiles_georecord', 'shapefile_id')
    ...
    models = {
        ...
        'profiles.geolevel': {
            ...
            'data_sources': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['profiles.DataSource']", 'symmetrical': 'False', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'profiles.georecord': {
            ...
            'shapefile': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['maps.ShapeFile']", 'null': 'True', 'blank': 'True'}),
