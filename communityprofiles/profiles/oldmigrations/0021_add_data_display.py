...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding M2M table for field levels on 'DataDisplay'
        db.create_table('profiles_datadisplay_levels', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('datadisplay', models.ForeignKey(orm['profiles.datadisplay'], null=False)),
            ('geolevel', models.ForeignKey(orm['profiles.geolevel'], null=False))
        ))
        db.create_unique('profiles_datadisplay_levels', ['datadisplay_id', 'geolevel_id'])

        # Adding M2M table for field records on 'DataDisplay'
        db.create_table('profiles_datadisplay_records', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('datadisplay', models.ForeignKey(orm['profiles.datadisplay'], null=False)),
            ('georecord', models.ForeignKey(orm['profiles.georecord'], null=False))
        ))
        db.create_unique('profiles_datadisplay_records', ['datadisplay_id', 'georecord_id'])

        # Adding M2M table for field domains on 'DataDisplay'
        db.create_table('profiles_datadisplay_domains', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('datadisplay', models.ForeignKey(orm['profiles.datadisplay'], null=False)),
            ('datadomain', models.ForeignKey(orm['profiles.datadomain'], null=False))
        ))
        db.create_unique('profiles_datadisplay_domains', ['datadisplay_id', 'datadomain_id'])

        # Adding M2M table for field indicators on 'DataDisplay'
        db.create_table('profiles_datadisplay_indicators', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('datadisplay', models.ForeignKey(orm['profiles.datadisplay'], null=False)),
            ('indicator', models.ForeignKey(orm['profiles.indicator'], null=False))
        ))
        db.create_unique('profiles_datadisplay_indicators', ['datadisplay_id', 'indicator_id'])

        # Changing field 'GeoRecord.geom'
        db.alter_column('profiles_georecord', 'geom', self.gf('django.contrib.gis.db.models.fields.GeometryField')(null=True))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'GeoRecord.geom'
        db.alter_column('profiles_georecord', 'geom', self.gf('django.contrib.gis.db.models.fields.MultiPolygonField')(null=True))
