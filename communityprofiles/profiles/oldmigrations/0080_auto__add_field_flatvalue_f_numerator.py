...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'FlatValue.f_numerator'
        db.add_column(u'profiles_flatvalue', 'f_numerator', self.gf('django.db.models.fields.CharField')(max_length='255', null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'FlatValue.f_numerator'
        db.delete_column(u'profiles_flatvalue', 'f_numerator')
    ...
    models = {
        ...
        u'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 1, 31, 13, 16, 11, 497788)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 1, 31, 13, 16, 11, 497392)'}),
