...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'FlatValue.numerator'
        db.add_column(u'profiles_flatvalue', 'numerator', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=10, decimal_places=2, blank=True), keep_default=False)

        # Deleting field 'TaskStatus.indicator'
        db.delete_column(u'profiles_taskstatus', 'indicator_id')


    def backwards(self, orm):
        
        # Deleting field 'FlatValue.numerator'
        db.delete_column(u'profiles_flatvalue', 'numerator')

        # Adding field 'TaskStatus.indicator'
        db.add_column(u'profiles_taskstatus', 'indicator', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['profiles.Indicator'], null=True, blank=True), keep_default=False)
    ...
    models = {
        ...
        u'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 1, 31, 13, 0, 18, 181025)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 1, 31, 13, 0, 18, 180584)'}),
